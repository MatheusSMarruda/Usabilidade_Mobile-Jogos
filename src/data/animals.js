...
export const getDifficultyConfig = (difficulty) => {
  switch (difficulty) {
    case 'easy':
      return { pairs: 6, cols: 4, label: 'Fácil', missPenalty: 5 };
    case 'medium':
      return { pairs: 8, cols: 4, label: 'Médio', missPenalty: 7 };
    case 'hard':
      return { pairs: 10, cols: 5, label: 'Difícil', missPenalty: 10 };
    default:
      return { pairs: 6, cols: 4, label: 'Fácil', missPenalty: 5 };
  }
};
